...
//  iQuiz
//
//  Created by Carolina Bortoli M.S on 06/02/24.
//
...
class QuestaoViewController: UIViewController {
    ...
    @IBAction func respostaBotaoPressionado(_ sender: UIButton) {
        ...
        if usuarioAcertouResposta {
            pontuacao += 1
            sender.backgroundColor = UIColor(red: 11/255, green: 161/255, blue: 53/255, alpha: 1.0) //verde
        } else {
            sender.backgroundColor = UIColor(red: 211/255, green: 17/255, blue: 17/255, alpha: 1.0) //vermelho
        }
